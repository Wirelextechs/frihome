# AfriHome - Two-Service Deployment Guide

This guide covers deploying AfriHome as **two independent services** (Backend API + Frontend Web).
...
```bash
npm run dev
# Should see: "AfriHome API listening on http://localhost:3001"
```
...
6. Deploy
7. Note the URL: `https://afrihome-api-xxxxx.onrender.com`

### Frontend Deployment:

1. Update `frontend/.env.production`:
   ```
   VITE_API_URL=https://afrihome-api-xxxxx.onrender.com
   ```
...
5. Deploy
6. Access at: `https://afrihome-web-xxxxx.onrender.com`
