...
>(({ className, children, icon, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-13 w-full items-center justify-between gap-2 rounded-2xl bg-input px-4 py-3.5 text-sm font-medium text-ink-900 outline-none transition data-[placeholder]:text-ink-400/70 focus:bg-white focus:ring-2 focus:ring-primary/40 disabled:cursor-not-allowed disabled:opacity-50 dark:focus:bg-ink-950",
      className,
    )}
    {...props}
  >
