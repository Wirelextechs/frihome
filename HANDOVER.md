# AfriHome Investment Platform - Developer Handover

**Date**: July 21, 2026  
**Repository**: https://github.com/wirelexcare/AfriHome  
...
**AfriHome** is a unified investment platform where users can:
...
### 1. Clone & Install
```bash
git clone https://github.com/wirelexcare/AfriHome.git
cd AfriHome
npm install
